...
// Verifica se o dark mode já está ativado
if (localStorage.getItem('dark-mode') === 'enabled') {
  document.body.classList.add('dark-mode');
  toggleSwitch.checked = true;
}

// Monitora mudanças no switch
toggleSwitch.addEventListener('change', () => {
  if (toggleSwitch.checked) {
    document.body.classList.add('dark-mode');
    localStorage.setItem('dark-mode', 'enabled');  // salva
  } else {
    document.body.classList.remove('dark-mode');
    localStorage.setItem('dark-mode', 'disabled'); // salva
  }
});
...
// Função para aplicar o tema e trocar as logos
function aplicarTema(isDark) {
  ...
  const logoIntro = document.querySelector(".intro");
